// Lab1Mokrushin.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main()
{
	...
	while (true) {
		...
		case 7:														// Загрузить из файла
		{
			...
			ifstream fin;
			fin.open(fileName + "Incident" + ".txt", ios::in);
